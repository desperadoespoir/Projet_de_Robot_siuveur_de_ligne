...
*				- Avancer : 0x00 (AVANCER)
*				- Reculer : 0x03 (RECULER)
*				- Tourner Droite : 0x02 (TDROITE)
*				- Tourner Gauche : 0x01 (TGAUCHE)
* Paramètres: 	- uint8_t dureeA : La durée pour le premier moteur (in)
*				- uint8_t dureeB : La durée pour le deuxième moteur (in)
*				- uint8_t direction : La direction du robot (utilise broche 4 & 7)
* Retour: aucun
****************************************************************************/
